  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'patriarch',
      content: '🔍 مرحباً بك في البحث الذكي! أنا خبير تاريخ الكنيسة القبطية الأرثوذكسية. يمكنني مساعدتك في العثور على أي بطريرك تبحث عنه بناءً على الاسم، الفترة الزمنية، الإنجازات، أو أي معلومة أخرى. فقط اكتب ما تبحث عنه وسأساعدك!',
      timestamp: new Date()
    }
  ]);
